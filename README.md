...
v1.4 新增 GitHub Actions APK 构建/发布流程，并补充英文 README  
...
**An Xposed module for ColorOS devices with shortcut keys, letting you customize what the hardware key does.**
...
Possible follow-up improvements:<br>
~~1. Separate settings for single press, double press, and long press~~ (done in v1.1)<br>
~~2. Support custom shell commands~~ (done in v1.3)<br>

## 📝Changelog

v1.4 Added GitHub Actions APK build/release automation and an English README  
